...
public class TcpOrchestratorServer
{
    ...
    private readonly ILogger<TcpOrchestratorServer> _logger;

    public TcpOrchestratorServer(
        IOrchestrator orchestrator, 
        int port, 
        IPAddress ip,
        TimeSpan inactivityTimeout,
        ILogger<TcpOrchestratorServer>? logger = null)
    {
        _orchestrator = orchestrator;
        _port = port;
        _inactivityTimeout = inactivityTimeout;
        _logger = logger ?? NullLogger<TcpOrchestratorServer>.Instance;
        _ip = ip;
    }
